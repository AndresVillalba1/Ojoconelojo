...
// Método para imprimir la matriz
   void Print() const {
      std::cout << "Matrix Kappa:" << std::endl;
...
int main(int argc, char *argv[])
{
    ...
    const char *mesh_file = "../data/ojodosvolumenes.msh";
    //const char *mesh_file = "../data/ojo-Fusion-boundaries.msh";
   ...
   MyMatrixCoefficient Kappa(pmesh.Dimension(),1.0,1.0);

   //Kappa.Eval();

   ConstantCoefficient Kappac(1.0);
   ...
   //ScalarMatrixProductCoefficient  m_nbc1Coef(corn_nbc, Kappa);
   //ScalarMatrixProductCoefficient  m_nbc2Coef(escl_nbc, Kappa);

   ProductCoefficient m_nbc1Coef(corn_nbc, Kappac);
   ProductCoefficient m_nbc2Coef(escl_nbc, Kappac);
 ...
 ParaViewDataCollection *pd = NULL;
   pd = new ParaViewDataCollection("proyectodosvolumenes", &pmesh);
